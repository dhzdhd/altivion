...
enum class MapStyle(val displayName: String, val url: String) {
  ...
  ProtomapsDarkGreyscale(
      "Protomaps Greyscale", Res.getUri("files/mapstyles/proto_dark_greyscale.json")),
...
data class SettingsState(
  ...
  companion object {
    val DEFAULT = SettingsState(ThemeMode.Dark, MapStyle.ProtomapsLight, MapStyle.ProtomapsDark)
  }
}
